...
public class TestCase_107 {
	...
	public void test() throws InterruptedException {
		...
		System.out.println("TestCase_107 Start");
		...
		while (count > 0) {
			try {
				...
				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/layout_text_ocb_push")).click();

				System.out.println("현재 동전알림 상태 : "
						+ driver.findElement(By.id("com.skmc.okcashbag.home_google:id/my_setting_push_popup_button"))
								.isEnabled());

				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/my_setting_push_main_button")).click();
