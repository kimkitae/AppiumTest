...
public class TestCase_113 {
	...
	public void test() throws InterruptedException {
		...
		System.out.println("TestCase_113 Start");
		...
		while (count > 0) {
			try {
				...
				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/my_custom_center_main_FAQ_text")).click();

				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/my_customer_center_faq_list_title_image"))
						.click();

				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/img_largearrow")).click();

				driver.navigate().back();

				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/img_middlearrow")).click();
				driver.navigate().back();
