...
public class TestCase_114 {
	...
	public void test() throws InterruptedException {
		...
		System.out.println("TestCase_114 Start");
		...
		while (count > 0) {
			try {
				...
				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/my_custom_center_main_require_text"))
						.click();

				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/img_emailarrow")).click();
				driver.findElement(By.xpath("//android.widget.ListView[1]/android.widget.TextView[2]")).click();

				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/my_customer_center_inquire_email_edittext"))
						.sendKeys("OCBTEST");
				...
				driver.findElement(
						By.id("com.skmc.okcashbag.home_google:id/my_customer_center_inquire_email_full_edittext"))
						.sendKeys("OCBTEST@sptek.com");

				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/left_btn")).click();
