...
public class TestCase_112 {
	...
	public void test() throws InterruptedException {
		...
		System.out.println("TestCase_112 Start");
		...
		while (count > 0) {
			try {
				...
				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/my_custom_center_main_notice_text")).click();
				
				
				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/my_custom_center_notice_row_text")).click();
