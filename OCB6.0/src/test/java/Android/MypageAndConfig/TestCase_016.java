...
public class TestCase_016 {
	...
	public void test() throws InterruptedException {
		...
		System.out.println("TestCase_016 Start");
		...
		while (count > 0) {
			try {
				...
				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/gnb_drawer_noti_list_button")).click();
