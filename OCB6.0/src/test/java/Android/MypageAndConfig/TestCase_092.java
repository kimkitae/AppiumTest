...
public class TestCase_092 {
	...
	public void test() throws InterruptedException {
		...
		System.out.println("TestCase_092 Start");
		...
		while (count > 0) {
			try {
				...
				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/layout_text_app_pwd")).click();

				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/password0")).sendKeys("0325");
				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/password1")).sendKeys("5230");
				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/password2")).sendKeys("5230");
				
				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/changeCardPasswordCheckBox")).click();
				...
				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/password0")).sendKeys("5230");
				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/password1")).sendKeys("0325");
				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/password2")).sendKeys("0325");
