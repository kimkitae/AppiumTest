...
public class TestCase_094 {
	...
	public void test() throws InterruptedException {
		...
		System.out.println("TestCase_094 Start");
		...
		while (count > 0) {
			try {
				...
				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/layout_text_otp_pwd")).click();
				...
				driver.findElement(By.id("com.skmc.okcashbag.home_google:id/reissuedButton")).click();
