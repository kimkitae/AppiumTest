...
public class TestCase_006 {
	...
	public void test() throws InterruptedException {
		...
		System.out.println("TestCase_006 Start");
		...
		while (count > 0) {
			...
			driver.findElement(By.id("com.skmc.okcashbag.home_google:id/img_my_profile_set")).click();
			
				driver.findElement(By.id("android:id/title").name("카메라 사용")).click();
				
				driver.findElement(By.id("MENUID_SHUTTER")).click();
				
				driver.findElement(By.id("com.sec.android.app.camera:id/okay")).click();
				driver.findElement(By.id("com.sec.android.gallery3d:id/action_done")).click();
